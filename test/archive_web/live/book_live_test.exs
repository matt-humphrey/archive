defmodule ArchiveWeb.BookLiveTest do
  use ArchiveWeb.ConnCase

  import Phoenix.LiveViewTest
  import Archive.BooksFixtures

  @create_attrs %{title: "some title", author: "some author", rating: 42, date_read: "2023-06-15T04:29:00"}
  @update_attrs %{title: "some updated title", author: "some updated author", rating: 43, date_read: "2023-06-16T04:29:00"}
